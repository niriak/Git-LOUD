...
local defaultOrdersTable = {
    ...
    RULEUCC_Attack = {              helpText = "attack",            bitmapId = 'attack',                preferredSlot = 2,  behavior = AttackOrderBehavior, initialStateFunc = AttackOrderInit},
    ...
    -- Unit specific rules
    RULEUCC_Overcharge = {          helpText = "overcharge",        bitmapId = 'overcharge',            preferredSlot = 4,  behavior = OverchargeBehavior,          initialStateFunc = OverchargeInit, onframe = OverchargeFrame},
