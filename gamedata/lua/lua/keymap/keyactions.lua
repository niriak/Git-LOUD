...
local keyActionsSelectionQuickSelect = {
    ...
    ['select_groundattack'] =  {
        action = 'UI_SelectByCategory AIR BOMBER, GROUNDATTACK',
        category = 'selection',
    },
    ['select_transport'] =  {
        action = 'UI_SelectByCategory AIR TRANSPORTFOCUS',
        category = 'selection',
    },
}
...
local keyActionsGame = {
    ...
    ['decrease_game_speed_by_3'] = {
        action = 'UI_Lua import("/lua/ui/uimain.lua").ChangeSimRate(-3)',
        category = 'game',
    },
    ['increase_game_speed_by_3'] = {
        action = 'UI_Lua import("/lua/ui/uimain.lua").ChangeSimRate(3)',
        category = 'game',
    },
    ['set_game_speed_minus_10'] = {
        action = 'WLD_GameSpeed -10',
        category = 'game',
    },
    ['set_game_speed_plus_10'] = {
        action = 'WLD_GameSpeed +10',
        category = 'game',
    },
    ['toggle_the_wind'] = {
        action = 'wld_RunWithTheWind',
        category = 'game',
    },
    ['reset_game_speed'] = {
...
local keyActionsUI = {
    ...
    ['toggle_markers_screen'] = {
        action = 'UI_Lua import("/lua/ui/dialogs/marker_utils_view.lua").OpenWindow()',
        category = 'ui',
    },
